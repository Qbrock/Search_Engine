...
public class ArgumentParser {
	...
	public static boolean isFlag(String arg) {
		// Changed to one line after reading your hint about one lining with map
	 ...
	 *   there is no mapping
	 *   I asked chatgpt how exactly to write a conditional in 1 line here and got the Ternary operator as an answer so I used that
	 */
