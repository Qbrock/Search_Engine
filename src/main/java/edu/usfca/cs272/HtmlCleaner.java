...
public class HtmlCleaner {
	 ...
	 * @see String#replaceAll(String, String)
	 *
	 * @CITE https://stackoverflow.com/questions/4075742/regex-to-strip-html-tags
	 */
	 ...
	 * @CITE https://www.w3schools.com/java/ref_string_replaceall.asp
	 * @CITE https://docs.oracle.com/javase/tutorial/essential/regex/index.html
	 */
	public static String stripEntities(String html) {
		return StringEscapeUtils.unescapeHtml4(html).replaceAll("&dash;", "");
	}
	 ...
	 *
	 * @see String#replaceAll(String, String)
	 * @CITE https://docs.oracle.com/javase/tutorial/essential/regex/quant.html
	 */
	 ...
	 * @see String#replaceAll(String, String)
	 * @CITE regex101 for the case insensitive
	 */
	public static String stripElement(String html, String name) {
		return html.replaceAll(String.format("(?s)(?i)<%s\\b.*?</%s\\s*>", name, name), "");
	}
